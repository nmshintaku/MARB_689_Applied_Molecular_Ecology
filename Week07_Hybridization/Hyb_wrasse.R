...
loc<-read.table("/scratch/group/kitchen-group/MARB_689_Molecular_Ecology/07_hybrids/loci.txt",check.names=FALSE, header=T, na.strings = c("", "NA"),
...
############
# load in all SNPs
file.copy("/scratch/group/kitchen-group/MARB_689_Molecular_Ecology/07_hybrids/west.filt.maf0.01.recode.vcf",".")
...
Dstat<-read.table("/scratch/group/kitchen-group/MARB_689_Molecular_Ecology/07_hybrids/SETs_wrasse_BBAA.txt", header=T)
Dstat
